...
int main (int argc, char** argv) {
    ...
    cout << endl << "Testando AREA DO TRIANGULO: " << endl;
    ...
    cout << endl << "Testando NORMALIZACAO DE UM VETOR: " << endl;

    vetor3d v19 = vetor3d(0.0, 4.0, 3.0);
    printf("\nV19 = ( %.3f , %.3f , %.3f )\n", v19.getX(), v19.getY(), v19.getZ());

    vetor3d v20 = v19.normalize();
    printf("\nV20 = V19 / || V19 ||\nV20 = ( %.3f , %.3f , %.3f )\n\n", v20.getX(), v20.getY(), v20.getZ());
